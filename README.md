...
> $\\\,$   
> <img src="https://github.com/HarryJamesGreenblatt/Make_Fake/blob/main/img/Make_Fake_Form_Without_Params.jpg?raw=true" alt="ufukkedup"></img>
> $\\\,$   
> $\\\,$   
> ...or may be alternatively invoked using custom parameters to define the attributes.
> $\\\,$   
> <img src="https://github.com/HarryJamesGreenblatt/Make_Fake/blob/main/img/Make_Fake_Form_With_Params.jpg?raw=true" alt="ufukkedup"></img>
